...
#https://git.kernel.org/pub/scm/linux/kernel/git/stable/linux.git/tree/Documentation/process/changes.rst?h=v5.16-rc1
#arm
KERNEL_ARCH=arm
DEBARCH=armhf
#toolchain="gcc_8_arm"
...
#https://mirrors.edge.kernel.org/pub/linux/kernel/projects/rt/5.16/
kernel_rt=".2-rt19"
#Kernel Build
BUILD=${build_prefix}29.1
