...
#https://git.kernel.org/pub/scm/linux/kernel/git/stable/linux.git/tree/Documentation/process/changes.rst?h=v5.17-rc1
#arm
KERNEL_ARCH=arm
DEBARCH=armhf
#toolchain="gcc_8_arm"
...
#https://mirrors.edge.kernel.org/pub/linux/kernel/projects/rt/5.17/
kernel_rt=".1-rt17"
#Kernel Build
BUILD=${build_prefix}20.1
